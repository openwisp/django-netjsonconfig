# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-24 12:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='template',
            name='create_cert',
            field=models.BooleanField(db_index=True, default=django_netjsonconfig.models.template.default_create_cert, help_text='whether a new x509 certificate should be created automatically for each configuration using this template, valid only for the VPN type', verbose_name='create certificate'),
        ),
        migrations.AddField(
            model_name='template',
            name='type',
