...
REGISTRATION_SELF_CREATION = getattr(settings, 'NETJSONCONFIG_REGISTRATION_SELF_CREATION', True)
...
MANAGEMENT_IP_DEVICE_LIST = getattr(settings, 'NETJSONCONFIG_MANAGEMENT_IP_DEVICE_LIST', True)
