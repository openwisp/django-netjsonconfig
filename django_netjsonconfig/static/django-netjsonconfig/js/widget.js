(function ($) {
    ...
    var initAdvancedEditor = function(target, data, schema){
        ...
        advanced.find('.jsoneditor-menu')
            .append($('<a href="javascript:;" class="jsoneditor-poweredBy"><img class="icon" src="/static/admin/img/icon-deletelink.svg" /> back to normal mode</a>'))
    ...
    var loadUi = function(backend, schemas, setInitialValue){
        $('.jsoneditor-raw').each(function(i, el){
            ...
            $("#advanced_editor").find('.jsoneditor-poweredBy').click(function(){
